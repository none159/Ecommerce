...
const Hero = ()=>{
     ...
     const reloadSliderright =()=>{
      ...
      const fetchtrending=async()=>{
        try{
        await axios.get("http://127.0.0.1:5000/api/trending").then((response)=>{
      ...
      const fetchonsale=async()=>{
        try{
        await axios.get("http://127.0.0.1:5000/api/onsale").then((response)=>{
      ...
      const fetchonslider=async()=>{
        try{
       await axios.get("http://127.0.0.1:5000/api/onslider").then((response)=>{
    ...
    if(image ==undefined && response.data!= undefined){
      ...
      const fetcharrival=async()=>{
        try{
       await axios.get("http://127.0.0.1:5000/api/arrival").then((response)=>{
