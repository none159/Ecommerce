...
const Fullinfoitem =()=>{
    ...
    const fetchitem = async()=>{
        try{
     await axios.get(`https://ecommerce-frontend-theta-plum.vercel.app/api/products/${id}?categorie=${categorie}`).then((response)=>{
    ...
    const addtofavorites = async()=>{
        await axios.post("https://ecommerce-frontend-theta-plum.vercel.app/api/users/favorite/save",{
            "productid":id,
            "email":JSON.parse(sessionStorage.getItem("email"))
